...
namespace tests\Libero\ViewsBundle\EventListener\CreateView;

use FluentDOM\DOM\Element;
use Libero\ViewsBundle\Event\CreateViewEvent;
use Libero\ViewsBundle\EventListener\CreateView\LangListener;
...
final class LangListenerTest extends TestCase
{
    ...
    public function it_does_nothing_if_there_is_already_a_lang_attribute() : void
    {
        ...
        $event = new CreateViewEvent($element, new View('template', ['attributes' => ['lang' => 'en']]));
        $listener->onCreateView($event);
        $view = $event->getView();
    ...
    public function it_sets_the_language_and_direction(
        ...
        $event = new CreateViewEvent($element, new View('template', [], $context));
        $listener->onCreateView($event);
        $view = $event->getView();
