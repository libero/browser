...
use Libero\JatsContentBundle\ViewConverter\FrontDisplayChannelContentMetaVisitor;
...
final class FrontDisplayChannelContentMetaVisitorTest extends TestCase
{
    ...
    {
        $visitor = new FrontDisplayChannelContentMetaVisitor(
...
XML
    ...
    public function it_sets_the_text_argument() : void
    {
        ...
        $visitor = new FrontDisplayChannelContentMetaVisitor($this->createDumpingConverter(), $translator);
