...
XML
        ...
        $this->assertEquals(
            [
                'text' => [
                    new View(null, ['object' => '/jats:italic/text()[1]', 'context' => ['qux' => 'quux']]),
                    new View(null, ['object' => '/jats:italic/jats:bold', 'context' => ['qux' => 'quux']]),
                    new View(null, ['object' => '/jats:italic/text()[2]', 'context' => ['qux' => 'quux']]),
                ],
            ],
            $view->getArguments()
        );
