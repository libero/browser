...
use Libero\JatsContentBundle\EventListener\BuildView\NameWesternListener;
...
final class NameWesternListenerTest extends TestCase
{
    ...
    {
        $listener = new NameWesternListener($this->createFailingConverter());
    ...
    {
        yield 'different namespace' => ['<name xmlns="http://example.com"><given-names>foo</given-names></name>'];
     ...
     * @test
     */
    public function it_does_nothing_if_it_is_no_a_western_name_style() : void
    {
        $listener = new NameWesternListener($this->createFailingConverter());
    ...
    {
        $listener = new NameWesternListener($this->createDumpingConverter());
    ...
    public function textProvider() : iterable
    {
        yield 'no style' => [
            <<<XML
<jats:name xmlns:jats="http://jats.nlm.nih.gov">
...
XML
        ...
        yield 'islensk' => [
            <<<XML
<jats:name xmlns:jats="http://jats.nlm.nih.gov" name-style="islensk">
    <jats:given-names>given names</jats:given-names>
</jats:name>
XML
            ,
        ...
        yield 'western' => [
            <<<XML
<jats:name xmlns:jats="http://jats.nlm.nih.gov" name-style="western">
    <jats:given-names>given names</jats:given-names>
</jats:name>
XML
            ,
