...
use Libero\JatsContentBundle\EventListener\BuildView\NameGivenOnlyListener;
...
final class NameGivenOnlyListenerTest extends TestCase
{
    ...
    {
        $listener = new NameGivenOnlyListener($this->createFailingConverter());
    ...
    public function nodeProvider() : iterable
    {
        yield 'different namespace' => [
            '<name xmlns="http://example.com" name-style="given-only"><given-names>foo</given-names></name>',
        ];
    ...
    public function it_does_nothing_if_is_not_the_link_template() : void
    {
        ...
        $element = $this->loadElement(
            '<name xmlns="http://jats.nlm.nih.gov" name-style="given-only"><given-names>foo</given-names></name>'
        );
     ...
     */
    public function it_does_nothing_if_it_is_not_given_only_name_style(?string $nameStyle) : void
    {
        $listener = new NameGivenOnlyListener($this->createFailingConverter());
    ...
    {
        $listener = new NameGivenOnlyListener($this->createDumpingConverter());
    ...
    public function textProvider() : iterable
    {
        yield 'minimum' => [
            <<<XML
<jats:name xmlns:jats="http://jats.nlm.nih.gov" name-style="given-only">
