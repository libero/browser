...
use Libero\JatsContentBundle\EventListener\CreateView\FrontItemTagsListener;
...
final class FrontItemTagsListenerTest extends TestCase
{
    ...
    public function it_does_nothing_if_it_is_not_a_jats_front_element(string $xml) : void
    {
        ...
        $event = new CreateViewEvent($element, new View('@LiberoPatterns/item-tags.html.twig'));
...
XML
        ...
        $event = new CreateViewEvent($element, new View('@LiberoPatterns/item-tags.html.twig', ['groups' => 'bar']));
        $listener->onCreateView($event);
        $view = $event->getView();
...
XML
        ...
        $context = ['qux' => 'quux'];
        $event = new CreateViewEvent($element, new View('@LiberoPatterns/item-tags.html.twig', [], $context));
        $listener->onCreateView($event);
        $view = $event->getView();
