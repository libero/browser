...
use Libero\JatsContentBundle\EventListener\ContextualDataListener;
...
final class ContextualDataListenerTest extends TestCase
{
    use PageTestCase;
    ...
    {
        $listener = new ContextualDataListener($this->createFailingConverter());
...
XML
     ...
     */
    public function it_adds_a_contextual_data(string $xml, array $context, array $expectedContextualData) : void
    {
        $listener = new ContextualDataListener($this->createDumpingConverter());
        ...
        $this->assertEquals([new TemplateView('', $expectedContextualData)], $event->getContent());
    }
...
XML
            ...
            [
                ...
                'template' => '@LiberoPatterns/contextual-data.html.twig',
                'context' => [
                    'lang' => 'en',
                    'dir' => 'ltr',
                    'area' => null,
